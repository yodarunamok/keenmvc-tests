...
$globalSiteData[".test1"] = array("raw_value" => "test", "template" => "%s1", "is_html" => false);
$globalSiteData[".test2"] = array("raw_value" => ["one", 2], "template" => "<em>test %s %d</em>", "is_html" => true, "replace_contents" => false);
